 ...
 *
 * Raised when a quiz is published.
 *
...
/**
 * Quiz published event class.
 *
 * @since 7.0.0
 */
final class QuizPublished implements DomainEvent {
     ...
     * Constructor.
     *
     * @param Quiz $quiz The published quiz.
     */
    ...
    public function get_payload(): array {
        return [
            ...
            'question_count' => count($this->quiz->get_questions())
        ];
    }
     ...
     * Get the quiz entity.
     *
     * @return Quiz The published quiz.
     */
