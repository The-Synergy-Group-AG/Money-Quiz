...
//	$plugin_activated = 1; 
	...
	// to process all admin forms at one place
 	if(isset($_POST['prospect_action']) && $_POST['prospect_action'] == "submit_new"){?>
		<div class='text-align-center result-loading-padding' style='padding-top:200px;padding-bottom:200px;text-align:center;background-color: #fff5d1;'><h1>Please wait while we personalize your results...<h1></div> 
		<?php
	...
	//	die();
 	...
 	if(isset($_POST['prospect_action']) && $_POST['prospect_action'] == "submit"){
		...
		$body .=  '<div class="include_summary ">
			<table class="form-table mq-form-table-reports" style=" border-collapse: separate; border-spacing: 0 1em;">
				<tbody>
					<tr>
						<th style="min-width:200px;text-align:left;" >Archetype</th>
						'.($all_values[49] == 'Yes' ? '<th style="min-width:200px;text-align:center;">'.$all_values[50].'</th>' : '').'
		...
		$temp_new_txt .= wpautop($email_setting['email_bottom_content']);
		$temp_new_txt .= wpautop($email_setting[7]);
  ...
  <tr>
    ...
    <td>
      ...
      <div style="padding-top: 10px;">
        <img src="<?php echo $signature_email[6]; ?>" alt="Take the Money Quiz" width="300" height="150" style="border-radius: 12px; display: block;">
      </div>
    </td>
  </tr>
</table>
...
?>		
		...
		<?php } ?>
			...
			?>	
				...
				<div class="mq-prospects mq-hide"  >
					...
					<div class="margin-bottom-30"><?php echo wpautop($register_page_seeting[3]);?></div>
					<div class="clear"></div>
    ...
    <div class="close-btn">×</div>
        <div class="mindfull-money-prefix-model-wrap">
			...
			<div class="mq-buttons-area mindfull-money-align-center" >
